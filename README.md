...
Using artificial intelligence and data-driven insights, the platform helps users understand how well their resume matches industry standards and offers suggestions to enhance it.
...
The system parses the resume content.

AI analyzes the resume structure, keywords, and sections.

A score and feedback report are generated.

The user receives suggestions to improve their resume.

Installation

Clone the repository:

git clone https://github.com/solidx74/ai-resume-analyzer.git
